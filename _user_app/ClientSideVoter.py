...
#======== Different paths to used files ================#
    ...
    sigfile = Path(os.path.join(path_to_buffers, "Signature"))
    #Path to blided file
    ...
    SignedBlindedVote=Path(os.path.join(path_to_buffers,"SignedBlindedVote.txt"))
    #The unblinded signed vote
    SignedUnBlindedVote=Path(os.path.join(path_to_buffers,"SignedUnBlindedVote.txt"))
    #The final signed vote
    SignedVote=Path(os.path.join(path_to_buffers,"SignedVote.txt"))
    #File tp send 
    ...
    Signature_Response=Path(os.path.join(path_to_buffers,"Registrer_signature.txt"))
    #File to write in the recieved Encrypted file 
    EncBlindFile=Path(os.path.join(path_to_buffers,"Blinded_encrypted.dat"))
    SendingFile_server=Path(os.path.join(path_to_buffers,'SignedEncVote.dat'))
